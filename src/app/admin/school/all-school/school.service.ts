...
export class SchoolService {
  ...
  getDataDS() {
    return this.http.get(`${authApi.baseURL}/school-ds`);
  }

  getData() {
    return this.http.get(`${authApi.baseURL}/schools`);
  }
  ...
  getOneData(id: number) {
    return this.http.get(`${authApi.baseURL}/school-get/${id}`);
  }

  updateOneData(id: number, updatedData: any) {
    return this.http.put<any>(
      `${authApi.baseURL}/school-update/${id}`,
      updatedData
    );
  }

  deleteOneData(id: number) {
    return this.http.delete(`${authApi.baseURL}/school-delete/${id}`);
  }
